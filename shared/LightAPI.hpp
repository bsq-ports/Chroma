...
namespace Chroma {
    ...
    public:
        ...
        static bool setLightColorSafe(GlobalNamespace::BeatmapEventType mb, bool refresh, std::optional<LSEData> color) noexcept {
        ...
        static void setAllLightingColorsSafe(bool refresh, std::optional<LSEData> lseData) {
