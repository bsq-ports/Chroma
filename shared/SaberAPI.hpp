...
namespace Chroma {
    ...
    public:
        ...
        static void setGlobalSaberColorSafe(int saberType, std::optional<Sombrero::FastColor> color) noexcept {
            static auto function = CondDeps::Find<void, int, std::optional<Sombrero::FastColor>>(CHROMA_ID, "setGlobalSaberColorSafe");
        ...
        static std::optional<Sombrero::FastColor> getSaberColorSafe(GlobalNamespace::SaberModelController* saberModelController) noexcept {
            static auto function = CondDeps::Find<OptColor, GlobalNamespace::SaberModelController*>(CHROMA_ID, "getSaberColorSafe");
        ...
        static void setSaberColorSafe(GlobalNamespace::SaberModelController* saberModelController, std::optional<Sombrero::FastColor> color) noexcept {
            static auto function = CondDeps::Find<void, GlobalNamespace::SaberModelController*, std::optional<Sombrero::FastColor>>(CHROMA_ID, "setSaberColorSafe");
        ...
        static void setSaberColorable(GlobalNamespace::SaberModelController* saberModelController, bool colorable) {
            static auto function = CondDeps::Find<void, GlobalNamespace::SaberModelController*, bool>(CHROMA_ID, "setSaberColorable");
        ...
        using SaberCallbackFunc = ThinVirtualLayer<void (void*, int, GlobalNamespace::SaberModelController*, Sombrero::FastColor)>;
        static void registerSaberCallback(const SaberCallbackFunc& callback) {
            static auto function = CondDeps::Find<void, const SaberCallbackFunc&>(CHROMA_ID, "registerSaberCallbackSafe");
