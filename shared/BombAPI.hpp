...
public:
  ...
  getBombNoteControllerOverrideColorSafe(GlobalNamespace::BombNoteController* BombNoteController) noexcept {
    static auto function = CondDeps::Find<OptColor, GlobalNamespace::BombNoteController*>(
        CHROMA_ID, "getBombNoteControllerOverrideColorSafe");
  ...
  /// THIS WILL NOT PLAY NICELY WITH MIRRORED Bomb CONTROLLER
  static std::optional<Sombrero::FastColor>
  getBombNoteControllerColorSafe(GlobalNamespace::BombNoteController* BombNoteController) noexcept {
    static auto function =
        CondDeps::Find<OptColor, GlobalNamespace::BombNoteController*>(CHROMA_ID, "getBombNoteControllerColorSafe");
  ...
  static void setBombColorSafe(GlobalNamespace::BombNoteController* nc,
                               std::optional<Sombrero::FastColor> color0) noexcept {
    static auto function =
        CondDeps::Find<void, GlobalNamespace::BombNoteController*, std::optional<Sombrero::FastColor>>(
            CHROMA_ID, "setBombColorSafe");
  ...
  static void setGlobalBombColorSafe(std::optional<Sombrero::FastColor> color0) noexcept {
    static auto function =
        CondDeps::Find<void, std::optional<Sombrero::FastColor>>(CHROMA_ID, "setGlobalBombColorSafe");
