...
MAKE_HOOK_MATCH(SliderController_Awake, &SliderController::Awake, void, SliderController* self) {
...
MAKE_HOOK_MATCH(SliderController_OnDestroy, &SliderController::OnDestroy, void, SliderController* self) {
