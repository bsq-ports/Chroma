...
MAKE_HOOK_MATCH(TrackLaneRingsRotationEffect_AddRingRotationEffect,
                &TrackLaneRingsRotationEffect::AddRingRotationEffect, void,
                GlobalNamespace::TrackLaneRingsRotationEffect* self, float angle, float step, int propagationSpeed,
                float flexySpeed) {
...
MAKE_HOOK_FIND_CLASS_UNSAFE_INSTANCE(ChromaRingsRotationEffect_AddRingRotationEffect, "Chroma",
                                     "ChromaRingsRotationEffect", "AddRingRotationEffect", void,
...
MAKE_HOOK_MATCH(TrackLaneRingsRotationEffect_FixedUpdate, &TrackLaneRingsRotationEffect::FixedUpdate, void,
                GlobalNamespace::TrackLaneRingsRotationEffect* self) {
  // Essentially, here we cancel the original method. DO NOT call it IF it's a Chroma map
  if (!ChromaController::DoChromaHooks()) {
