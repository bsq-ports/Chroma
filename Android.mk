...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DDEBUGB='1' -DID='"chroma"' -DVERSION='"2.4.10q5"' -I'./shared' -I'./extern' -isystem'extern/codegen/include' -isystem'extern/boost-regex/regex/include/' -O3
