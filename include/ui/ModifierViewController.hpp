...
DECLARE_CLASS_CODEGEN(Chroma, ModifierViewController, HMUI::ViewController,
                      ...
                      DECLARE_OVERRIDE_METHOD(void, DidActivate2, il2cpp_utils::FindMethodUnsafe("HMUI", "ViewController", "DidActivate", 3), bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);
