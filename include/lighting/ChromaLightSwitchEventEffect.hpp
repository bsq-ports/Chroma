...
DECLARE_CLASS_CODEGEN(
    Chroma, ChromaLightSwitchEventEffect, GlobalNamespace::LightSwitchEventEffect, public
    ...
    Sombrero::FastColor _lightColor0Mult; Sombrero::FastColor _lightColor1Mult;
    Sombrero::FastColor _highlightColor0Mult; Sombrero::FastColor _highlightColor1Mult;
    Sombrero::FastColor _lightColor0BoostMult; Sombrero::FastColor _lightColor1BoostMult;
    Sombrero::FastColor _highlightColor0BoostMult; Sombrero::FastColor _highlightColor1BoostMult;
    ...
    DECLARE_INSTANCE_METHOD(void, Awake); DECLARE_INSTANCE_METHOD(void, OnDestroy); DECLARE_SIMPLE_DTOR();
    DECLARE_DEFAULT_CTOR();

    public
    : static std::unordered_set<ChromaLightSwitchEventEffect*>
        livingLightSwitch;
